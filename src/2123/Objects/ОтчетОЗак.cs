...
namespace IIS.2123
{
    ...
    public class ОтчетОЗак : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.2123.СостПоставок fСостОтгрузки;
        
        private IIS.2123.СостОплаты fСостояниеОплаты;
        
        private System.DateTime fДатаОкончания;
        
        private bool fСуммаВклНДС;
        
        private IIS.2123.Склады fСклады;
        
        private IIS.2123.Организации fОрганизации;
        
        private IIS.2123.Контрагенты fКонтрагенты;
        
        private IIS.2123.DetailArrayOfТЧЗаказ fТЧЗаказ;
        ...
        public virtual IIS.2123.СостПоставок СостОтгрузки
        {
            get
            {
                ...
                IIS.2123.СостПоставок result = this.fСостОтгрузки;
        ...
        public virtual IIS.2123.СостОплаты СостояниеОплаты
        {
            get
            {
                ...
                IIS.2123.СостОплаты result = this.fСостояниеОплаты;
        ...
        [PropertyStorage(new string[] {
                "Контрагенты"})]
        [NotNull()]
        public virtual IIS.2123.Контрагенты Контрагенты
        {
            get
            {
                ...
                IIS.2123.Контрагенты result = this.fКонтрагенты;
        ...
        [PropertyStorage(new string[] {
                "Организации"})]
        [NotNull()]
        public virtual IIS.2123.Организации Организации
        {
            get
            {
                ...
                IIS.2123.Организации result = this.fОрганизации;
        ...
        [PropertyStorage(new string[] {
                "Склады"})]
        [NotNull()]
        public virtual IIS.2123.Склады Склады
        {
            get
            {
                ...
                IIS.2123.Склады result = this.fСклады;
        ...
        public virtual IIS.2123.DetailArrayOfТЧЗаказ ТЧЗаказ
        {
            get
            {
                ...
                {
                    this.fТЧЗаказ = new IIS.2123.DetailArrayOfТЧЗаказ(this);
                }
                IIS.2123.DetailArrayOfТЧЗаказ result = this.fТЧЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОтчетОЗакE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОЗакE", typeof(IIS.2123.ОтчетОЗак));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОтчетОЗакL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОЗакL", typeof(IIS.2123.ОтчетОЗак));
                }
            }
        }
    }
