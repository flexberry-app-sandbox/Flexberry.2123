...
namespace IIS.2123
{
    ...
    public class ТЧЗаказ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.2123.ОтчетОЗак fОтчетОЗак;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.2123.ОтчетОЗак.
        /// </summary>
        ...
        [TypeUsage(new string[] {
                "IIS.2123.ЗаказПост",
                "IIS.2123.ОтчетОЗак"})]
        public virtual IIS.2123.ОтчетОЗак ОтчетОЗак
        {
            get
            {
                ...
                IIS.2123.ОтчетОЗак result = this.fОтчетОЗак;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧЗаказE", typeof(IIS.2123.ТЧЗаказ));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧЗаказ : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.2123.DetailArrayOfТЧЗаказ members)

        // *** End programmer edit section *** (IIS.2123.DetailArrayOfТЧЗаказ members)
        ...
        /// </summary>
        public DetailArrayOfТЧЗаказ(IIS.2123.ОтчетОЗак fОтчетОЗак) : 
                base(typeof(ТЧЗаказ), ((ICSSoft.STORMNET.DataObject)(fОтчетОЗак)))
        {
        }
        
        public IIS.2123.ТЧЗаказ this[int index]
        {
            get
            {
                return ((IIS.2123.ТЧЗаказ)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.2123.ТЧЗаказ dataobject)
        {
