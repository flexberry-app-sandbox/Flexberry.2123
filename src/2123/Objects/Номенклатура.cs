...
namespace IIS.2123
{
    ...
    public class Номенклатура : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.2123.ЕдиницыИзмер fЕдиницыИзмер;
        ...
        [PropertyStorage(new string[] {
                "ЕдиницыИзмер"})]
        [NotNull()]
        public virtual IIS.2123.ЕдиницыИзмер ЕдиницыИзмер
        {
            get
            {
                ...
                IIS.2123.ЕдиницыИзмер result = this.fЕдиницыИзмер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View НоменклатураE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НоменклатураE", typeof(IIS.2123.Номенклатура));
                }
            }
            ...
            public static ICSSoft.STORMNET.View НоменклатураL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НоменклатураL", typeof(IIS.2123.Номенклатура));
                }
            }
        }
    }
