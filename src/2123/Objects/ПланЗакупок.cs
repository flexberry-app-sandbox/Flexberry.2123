...
namespace IIS.2123
{
    ...
    public class ПланЗакупок : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.2123.DetailArrayOfПлан fплан;
        ...
        public virtual IIS.2123.DetailArrayOfПлан план
        {
            get
            {
                ...
                if ((this.fплан == null))
                {
                    this.fплан = new IIS.2123.DetailArrayOfПлан(this);
                }
                IIS.2123.DetailArrayOfПлан result = this.fплан;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланЗакупокE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланЗакупокE", typeof(IIS.2123.ПланЗакупок));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПланЗакупокL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланЗакупокL", typeof(IIS.2123.ПланЗакупок));
                }
            }
        }
    }
