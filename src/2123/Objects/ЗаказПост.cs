...
namespace IIS.2123
{
    ...
    [View("ЗаказПостL", new string[] {
            ...
            "ДатаОкончания as \'Дата окончания\'",
            "Номер as \'Номер\'"})]
    public class ЗаказПост : IIS.2123.ОтчетОЗак
    {
        
        private IIS.2123.DetailArrayOfТЧЗаказ fЗаказ;
        ...
        public override IIS.2123.СостПоставок СостОтгрузки
        {
            get
            {
                ...
                IIS.2123.СостПоставок result = base.СостОтгрузки;
        ...
        public override IIS.2123.СостОплаты СостояниеОплаты
        {
            get
            {
                ...
                IIS.2123.СостОплаты result = base.СостояниеОплаты;
        ...
        [TypeUsage(typeof(IIS.2123.Контрагенты))]
        [PropertyStorage(new string[] {
                "Контрагенты"})]
        public override IIS.2123.Контрагенты Контрагенты
        {
            get
            {
                ...
                IIS.2123.Контрагенты result = ((IIS.2123.Контрагенты)(base.Контрагенты));
            ...
            set
            {
                ...
                base.Контрагенты = ((IIS.2123.Контрагенты)(value));
        ...
        [TypeUsage(typeof(IIS.2123.Организации))]
        [PropertyStorage(new string[] {
                "Организации"})]
        public override IIS.2123.Организации Организации
        {
            get
            {
                ...
                IIS.2123.Организации result = ((IIS.2123.Организации)(base.Организации));
            ...
            set
            {
                ...
                base.Организации = ((IIS.2123.Организации)(value));
        ...
        [TypeUsage(typeof(IIS.2123.Склады))]
        [PropertyStorage(new string[] {
                "Склады"})]
        public override IIS.2123.Склады Склады
        {
            get
            {
                ...
                IIS.2123.Склады result = ((IIS.2123.Склады)(base.Склады));
            ...
            set
            {
                ...
                base.Склады = ((IIS.2123.Склады)(value));
        ...
        public virtual IIS.2123.DetailArrayOfТЧЗаказ Заказ
        {
            get
            {
                ...
                if ((this.fЗаказ == null))
                {
                    this.fЗаказ = new IIS.2123.DetailArrayOfТЧЗаказ(this);
                }
                IIS.2123.DetailArrayOfТЧЗаказ result = this.fЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаказПостE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказПостE", typeof(IIS.2123.ЗаказПост));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаказПостL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказПостL", typeof(IIS.2123.ЗаказПост));
                }
            }
        }
    }
